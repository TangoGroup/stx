...
func LoadConfig(path string) (*ConfigFile, error) {
	...
	if _, err := os.Stat(path); err == nil {
		...
		return nil, errors.New("aws config files not found")
	}
	return config, nil
}
...
// GetSessionTokenDuration returns time
